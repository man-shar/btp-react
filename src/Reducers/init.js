export const initialState = {
  "overallAttributes": {
    "width": 900,
    "height": 600,
    "backgroundFill$name": "background-fill",
    "backgroundFill$value": "#fff",
    "backgroundFill$exprString": "#fff",
    "border$name": "border",
    "border$value": "#f5f5f5",
    "border$exprString": "#f5f5f5",
    ...
    "styleList": ["border", "backgroundFill", "alignmentBaseline", "baselineShift", "direction", "display", "dominantBaseline", "fill", "fillOpacity", "fontFamily", "fontSize", "fontStyle", "fontWeight", "opacity", "stroke", "strokeOpacity", "strokeWidth", "textAnchor", "textDecoration", "visibility"]
  },
  "drawing": {
    "hoveredAttributeId": "",
    "beingDrawn": false,
